...
#       cd /tmp
	...
	#echo "Installing installHttrPackage.r `date`"
        #sudo R CMD BATCH /root/scripts/installHttrPackage.r /root/installHttrPackage_${now}.log
	...
	#echo "Installing installJsonlitePackage.r `date`"
        #sudo R CMD BATCH /root/scripts/installJsonlitePackage.r /root/installJsonlitePackage_${now}.log
	...
	#echo "Installing installR6Package.r `date`"
        #sudo R CMD BATCH /root/scripts/installR6Package.r /root/installR6Package_${now}.log
	...
	#echo "Installing installHttpuvPackage.r `date`"
        #sudo R CMD BATCH /root/scripts/installHttpuvPackage.r /root/installHttpuvPackage_${now}.log
	...
	#echo "Installing installBigqueryPackage.r `date`"
        #sudo R CMD BATCH /root/scripts/installBigqueryPackage.r /root/installBigqueryPackage_${now}.log
	...
	#echo "Installing installGoogleAuthRPackage.r `date`"
        #sudo R CMD BATCH /root/scripts/installGoogleAuthRPackage.r /root/installGoogleAuthRPackage_${now}.log
	...
	sudo R CMD BATCH /root/scripts/installLubridatePackage.r /root/installLubridatePackage_${now}.log
